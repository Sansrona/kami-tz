<template>
    <div class="form-container">
        <div class="header">
            ...
            <TypographyTitle :level="3">Добавить товар</TypographyTitle>
        </div>
        <div>
...
//     };
// }
// const handleValidate = (name: string | number | string[] | number[], status: boolean, errors: string[]) => {
//     if (!previewImage.value.length) {
//         message.warning('Нет изображения');
//     }
//     console.log(name, status, errors, 'yo');
// };
